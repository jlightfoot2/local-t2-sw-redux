...
exports.updatesCheckStart = () => {
    return {
        type: exports.UPDATES_CHECK_REQUEST_START
    };
};
exports.updatesCheckEnd = () => {
    return {
...
exports.cacheStatusChange = (isReady) => {
    return {
        type: exports.CACHE_STATUS_CHANGE,
        isReady
    };
};
exports.updatesAvailable = (available, meta = '') => {
    return {
...
exports.updateUserNotified = (notified) => {
    return {
        type: exports.UPDATES_USER_NOTIFIED,
        notified
    };
};
exports.swLogEvent = (name, info = undefined) => {
